...
class ViaCepResponseDTOTest {
    ...
    @Test
    void allArgsTest() {
        ViaCepResponseDTO responseDTO = new ViaCepResponseDTO("teste","teste","teste","teste","teste","teste","teste","teste","teste","teste","teste","teste");
        assertEquals("teste", responseDTO.getCep());
    }
